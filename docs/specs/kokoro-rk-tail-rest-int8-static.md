...
**Submodule commit:** `65b9a13` (Seeed-Solution/rkvoice-stream @ feat/kokoro-rk-4stage-vocoder-front) — `feat(tts/kokoro): bucket-8 tail-rest static MM+Gemm INT8 (env-gated)`

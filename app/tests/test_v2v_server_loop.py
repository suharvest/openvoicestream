...
Covers:
  * EdgeLLMBackend (app/core/edge_llm_backend.py) — mocked httpx SSE →
...
from app.core.edge_llm_backend import EdgeLLMBackend, edge_llm_base_url
...
def test_server_loop_flag_off_no_llm_no_registry(monkeypatch):
    ...
    This mirrors the exact flag-branch logic in app/main.py without spinning up
    ...
    # Off → registry None, no llm key. (The app/main.py block guards all LLM
